      ...
      <div className="container">
        {open && (
          <CustomModal
                  ...
                  <div className="w-full flex flex-col">
                    <div className="flex-1 mb-4">
                      ...
                      <DatePicker
                        ...
                        defaultValue={dayjs(modalData.sched_date)}
                        onChange={(newDate) => setNewSchedDate(newDate)}
                      />
                    </div>
                    <div className="flex-1 flex items-center mt-4 gap-8">
                      <div className="flex flex-col">
                        <p className="mb-1 text-2xl">Time</p>
                        <TimePicker
                          // ampm={false}
                          value={timeStart}
                          defaultValue={dayjs(modalData.sched_timestart)}
            ...
            additions={
              <button
                onClick={() => handleSubmitReschedule(modalData.sched_id)}
        ...
        <div className="flex row-auto ">
          ...
          <div style={{ flex: 2 }}>
            <div className="p-4">
              ...
              <span>
                <Moment format="MMMM DD, YYYY">{selectedDate}</Moment>
              </span>{" "}
                    ...
                    <div className="space-y-3" key={appointment.sched_id}>
                      ...
                      <div className="flex row-auto justify-between items-center">
                        ...
                        <div className="ml-auto">
                          <Link
                            to={`/applications?appId=${appointment.sched_appid}`}
                          >
                      ...
                      <span>
                        <Moment format="hh:mm A" parse="HH:mm:ss">
                          {appointment.sched_timestart}
                        </Moment>{" "}
                      </span>
                      {appointment.sched_zoomlink &&
                      appointment.sched_zoomlink.length > 0
