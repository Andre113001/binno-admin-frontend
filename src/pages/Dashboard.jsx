  ...
  return (
    <div>
      ...
      <div className="container-body">
        <h1 className="heading-1 flex justify-center">BiNNO Dashboard</h1>

        <div
          className="navigation-controller container flex flex-col items-center justify-center p-5 m-5
